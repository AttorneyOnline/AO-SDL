...
MusicAreaModel::MusicAreaModel(QObject* parent)
...
QVariant MusicAreaModel::data(const QModelIndex& index, int role) const {
    ...
    case PlayerCountRole: return e.playerCount;
    case IsAreaRole:      return e.isArea;
    case StatusRole:      return e.status;
    case CmRole:          return e.cm;
    case LockRole:        return e.lock;
    default:              return {};
    }
}
