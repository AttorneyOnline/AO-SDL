...
class AOAssetLibrary {
  public:
    ...
    std::optional<RawAsset> character_emote(const std::string& character, const std::string& emote, EmoteType type);
    ...
    std::optional<RawAsset> background(const std::string& name, const std::string& position);

    std::optional<RawAsset> background_overlay(const std::string& name, const std::string& position);
    ...
    std::optional<RawAsset> theme_image(const std::string& element, const std::string& theme,
                                        const std::string& subtheme = "", const std::string& misc = "");

    std::optional<IniDocument> theme_config(const std::string& filename, const std::string& theme,
                                            const std::string& subtheme = "", const std::string& misc = "");
    ...
    std::optional<RawAsset> shout(ShoutType type, const std::string& theme, const std::string& misc = "",
                                  const std::string& custom_name = "");

    std::optional<RawAsset> effect(const std::string& name, const std::string& theme, const std::string& misc = "");

    std::optional<RawAsset> effect_icon(const std::string& name, const std::string& theme,
    ...
    std::optional<RawAsset> sfx(const std::string& name, const std::string& character = "",
                                const std::string& misc = "");
  ...
  private:
    ...
    std::vector<std::string> resolve_paths(const std::string& element, const std::string& theme,
                                           const std::string& subtheme, const std::string& misc);
};
